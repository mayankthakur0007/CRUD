 ...
 * @polymer
 */
class Polymer3CrudApp extends PolymerElement {
  static get template() {
    return html`
<style>
#form{
...
<paper-button raised on-click="_handleEditSubmit"  class="btn btn-primary" id="edit">Edit</paper-button>
  ...
  <highcharts-chart type='column' data={{data}} x-axis = '{"categories":["HTML", "CSS", "JAVASCRIPT", "POLYMER"]}' export=true y-label='Percentage Completed'></highcharts-chart>
...
window.customElements.define('polymer-3-crud-app', Polymer3CrudApp);
